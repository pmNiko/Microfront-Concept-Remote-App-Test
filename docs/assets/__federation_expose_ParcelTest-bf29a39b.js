import { r as reactExports, g as getDefaultExportFromCjs, a as getAugmentedNamespace } from './index-9f2b72ad.js';
...
const maybeReactUseId = React$x['useId' + ''];
/**
 *
...
var Emotion = /* #__PURE__ */withEmotionCache(function (props, cache, ref) {
  ...
  var serialized = serializeStyles(registeredStyles, undefined, React$r.useContext(ThemeContext));
  ...
  return /*#__PURE__*/React$r.createElement(React$r.Fragment, null, /*#__PURE__*/React$r.createElement(Insertion$2, {
    cache: cache,
    serialized: serialized,
    isStringTag: typeof WrappedComponent === 'string'
  }), /*#__PURE__*/React$r.createElement(WrappedComponent, newProps));
});
...
var ClassNames = /* #__PURE__ */withEmotionCache(function (props, cache) {
  ...
  var content = {
    css: css,
    cx: cx,
    theme: React$q.useContext(ThemeContext)
  };
  var ele = props.children(content);
  hasRendered = true;
  return /*#__PURE__*/React$q.createElement(React$q.Fragment, null, /*#__PURE__*/React$q.createElement(Insertion$1, {
    cache: cache,
...
function createBox(options = {}) {
  ...
  const Box = /*#__PURE__*/React$n.forwardRef(function Box(inProps, ref) {
    ...
    const _extendSxProp = extendSxProp(inProps),
      ...
      other = _objectWithoutPropertiesLoose(_extendSxProp, _excluded$k);
...
const _excluded$i = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
...
function createStyled(input = {}) {
  ...
  return (tag, inputOptions = {}) => {
    ...
    const {
      ...
      options = _objectWithoutPropertiesLoose(inputOptions, _excluded$i);
...
const SvgIcon = /*#__PURE__*/React$k.forwardRef(function SvgIcon(inProps, ref) {
...
function createSvgIcon$1(path, displayName) {
  ...
  return /*#__PURE__*/React$j.memo( /*#__PURE__*/React$j.forwardRef(Component));
}
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React$g.useState(false);
 ...
 */
const TouchRipple = /*#__PURE__*/React$f.forwardRef(function TouchRipple(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiTouchRipple'
  });
  ...
  const [ripples, setRipples] = React$f.useState([]);
  const nextKey = React$f.useRef(0);
  const rippleCallback = React$f.useRef(null);
  React$f.useEffect(() => {
  ...
  const ignoringMouseDown = React$f.useRef(false);
  // We use a timer in order to only show the ripples for touch "click" like events.
  // We don't want to display the ripple for touch scroll events.
  const startTimer = React$f.useRef(null);

  // This is the hook called once the previous timeout is ready.
  const startTimerCommit = React$f.useRef(null);
  const container = React$f.useRef(null);
  React$f.useEffect(() => {
    return () => {
      clearTimeout(startTimer.current);
    };
  }, []);
  const startCommit = React$f.useCallback(params => {
    const {
      pulsate,
      rippleX,
      rippleY,
  ...
  const start = React$f.useCallback((event = {}, options = {}, cb = () => {}) => {
    const {
      pulsate = false,
  ...
  const pulsate = React$f.useCallback(() => {
    start({}, {
      pulsate: true
    });
  }, [start]);
  const stop = React$f.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
 ...
 */
const ButtonBase = /*#__PURE__*/React$e.forwardRef(function ButtonBase(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiButtonBase'
  });
  ...
  const buttonRef = React$e.useRef(null);
  const rippleRef = React$e.useRef(null);
  ...
  const [focusVisible, setFocusVisible] = React$e.useState(false);
  if (disabled && focusVisible) {
    setFocusVisible(false);
  }
  React$e.useImperativeHandle(action, () => ({
    focusVisible: () => {
      setFocusVisible(true);
      buttonRef.current.focus();
    }
  }), []);
  const [mountedState, setMountedState] = React$e.useState(false);
  React$e.useEffect(() => {
   ...
   */
  const keydownRef = React$e.useRef(false);
...
IconButton.propTypes /* remove-proptypes */ = {
  ...
  children: chainPropTypes(PropTypes.node, props => {
    const found = React$d.Children.toArray(props.children).some(child => /*#__PURE__*/React$d.isValidElement(child) && child.props.onClick);
    if (found) {
...
const Button = /*#__PURE__*/React$a.forwardRef(function Button(inProps, ref) {
  // props priority: `inProps` > `contextProps` > `themeDefaultProps`
  const contextProps = React$a.useContext(ButtonGroupContext$1);
...
const Divider = /*#__PURE__*/React$9.forwardRef(function Divider(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiDivider'
  });
 ...
 * @ignore - internal component.
 */
const GridContext = /*#__PURE__*/React$8.createContext();
{
...
const _excluded$5 = ["className", "columns", "columnSpacing", "component", "container", "direction", "item", "rowSpacing", "spacing", "wrap", "zeroMinWidth"];
...
const Grid = /*#__PURE__*/React$7.forwardRef(function Grid(inProps, ref) {
  const themeProps = useThemeProps({
    props: inProps,
    name: 'MuiGrid'
  });
  ...
  const columnsContext = React$7.useContext(GridContext$1);
 ...
 */
const LinearProgress = /*#__PURE__*/React$6.forwardRef(function LinearProgress(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiLinearProgress'
  });
 ...
 * @ignore - internal component.
 */
const ListContext = /*#__PURE__*/React$5.createContext({});
{
...
const List = /*#__PURE__*/React$4.forwardRef(function List(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiList'
  });
 ...
 */
const ListItemSecondaryAction = /*#__PURE__*/React$3.forwardRef(function ListItemSecondaryAction(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiListItemSecondaryAction'
  });
  ...
  const context = React$3.useContext(ListContext$1);
  const ownerState = _extends({}, props, {
 ...
 */
const ListItem = /*#__PURE__*/React$2.forwardRef(function ListItem(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiListItem'
  });
...
ListItem.propTypes /* remove-proptypes */ = {
   ...
   */
  children: chainPropTypes(PropTypes.node, props => {
    const children = React$2.Children.toArray(props.children);
...
const CardContainer = ({
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Grid$1, { container: true, display: "flex", justifyContent: "center", mt, mb, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Grid$1, { item: true, xs, sm, md, lg, mt: 13, mb: 2, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    Box$1,
    {
      sx: {
      ...
      children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            ...
            false,
            {
              fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/CardContainer.tsx",
              lineNumber: 61,
              columnNumber: 13
            },
            globalThis
          ),
          showImage && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { textAlign: "center", mt: 6, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            "img",
            {
...
var default_1$1 = Fingerprint.default = void 0;
...
default_1$1 = Fingerprint.default = _default$1;
    ...
    window.dispatchEvent(
      new CustomEvent("ADD_TO_CART_TEST", {
        detail: {
          ...
          price: 80.9,
          date: /* @__PURE__ */ new Date("2014-07-02")
        }
      })
    );
  };
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { p: 2, children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Typography$1, { variant: "caption", children: "Capture los eventos en el App Shell" }, void 0, false, {
      fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/CustomButton/index.tsx",
      lineNumber: 27,
      columnNumber: 7
    }, globalThis),
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { sx: { display: "flex", flexWrap: "wrap", gap: 4 }, children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { mx: "auto", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Typography$1, { variant: "subtitle2", sx: { fontWeight: "bold" }, mt: 2, children: "EVENT_TEST" }, void 0, false, {
          fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/CustomButton/index.tsx",
          lineNumber: 33,
          columnNumber: 11
        }, globalThis),
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          IconButton$1,
          {
            ...
            children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(default_1$1, {}, void 0, false, {
              fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/CustomButton/index.tsx",
              lineNumber: 41,
              columnNumber: 13
            }, globalThis)
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { mx: "auto", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Typography$1, { variant: "subtitle2", sx: { fontWeight: "bold" }, mt: 2, children: "ADD_TO_CART_TEST" }, void 0, false, {
          fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/CustomButton/index.tsx",
          lineNumber: 46,
          columnNumber: 11
        }, globalThis),
...
var default_1 = Comment.default = void 0;
var _createSvgIcon = _interopRequireDefault(requireCreateSvgIcon());
var _jsxRuntime = requireJsxRuntime();
var _default = (0, _createSvgIcon.default)( /*#__PURE__*/(0, _jsxRuntime.jsx)("path", {
  d: "M21.99 4c0-1.1-.89-2-1.99-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14l4 4-.01-18zM18 14H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"
}), 'Comment');
default_1 = Comment.default = _default;

const React = await importShared('react');
function LinearProgressWithLabel(props) {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { sx: { display: "flex", alignItems: "center" }, children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { sx: { width: "100%", mr: 1 }, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(LinearProgress$1, { variant: "determinate", ...props }, void 0, false, {
      fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Loading/Loading.tsx",
      lineNumber: 14,
      columnNumber: 9
    }, this) }, void 0, false, {
      fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Loading/Loading.tsx",
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { sx: { minWidth: 35 }, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Typography$1, { variant: "body2", color: "text.secondary", children: `${Math.round(
      props.value
    )}%` }, void 0, false, {
      fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Loading/Loading.tsx",
      lineNumber: 17,
...
function Loading({
  ...
  React.useEffect(() => {
    const timer = setInterval(() => {
      setProgress(
        (prevProgress) => prevProgress >= 100 ? 10 : prevProgress + 25
      );
    }, 800);
    return () => {
      clearInterval(timer);
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { sx: { width: "100%" }, children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(LinearProgressWithLabel, { value: progress, color }, void 0, false, {
    fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Loading/Loading.tsx",
    lineNumber: 45,
    columnNumber: 7
  }, this) }, void 0, false, {
...
const Todos = () => {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { mx: 5, mt: 5, children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Divider$1, {}, void 0, false, {
      fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Todos/index.tsx",
      lineNumber: 51,
      columnNumber: 7
    }, globalThis),
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Stack$1, { direction: "column", spacing: 2, p: 2, alignItems: "center", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Typography$1, { mt: 2, variant: "caption", children: "Maneje el error en el App Shell" }, void 0, false, {
        fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Todos/index.tsx",
        lineNumber: 53,
        columnNumber: 9
      }, globalThis),
      ...
      isErrorFetching && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Loading, { color: "error" }, void 0, false, {
        fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Todos/index.tsx",
        lineNumber: 66,
        columnNumber: 29
      }, globalThis),
      dataError.map((elem, index) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { children: elem.title }, index, false, {
        fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Todos/index.tsx",
        lineNumber: 68,
        columnNumber: 11
      }, globalThis))
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Stack$1, { direction: "column", spacing: 2, mt: 4, alignItems: "center", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Typography$1, { variant: "caption", children: "La solicitud se realiza con éxito" }, void 0, false, {
        fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Todos/index.tsx",
        lineNumber: 73,
        columnNumber: 9
      }, globalThis),
      ...
      isLoading && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Loading, {}, void 0, false, {
        fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Todos/index.tsx",
        lineNumber: 85,
        columnNumber: 23
      }, globalThis),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          List$1,
          {
            ...
            children: todos?.map((todo, index) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
              ListItem$1,
              {
                disableGutters: true,
                secondaryAction: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(IconButton$1, { "aria-label": "comment", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(default_1, {}, void 0, false, {
                  fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Todos/index.tsx",
                  lineNumber: 97,
                  columnNumber: 21
                }, globalThis) }, void 0, false, {
                ...
                children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(ListItemText$1, { primary: ` ${todo.title}` }, void 0, false, {
                  fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Todos/index.tsx",
                  lineNumber: 101,
                  columnNumber: 17
                }, globalThis)
        ...
        todos.length > 0 && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
          Button$1,
          {
            ...
            color: "secondary",
            onClick: () => setTodos([]),
            children: "Limpiar tareas cargadas"
          },
          void 0,
          false,
          {
...
const Title = () => {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { mt: -3, children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: "https://vitejs.dev", target: "_blank", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("img", { src: viteLogo, className: "logo", alt: "Vite logo" }, void 0, false, {
        fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Title/index.tsx",
        lineNumber: 10,
        columnNumber: 11
      }, globalThis) }, void 0, false, {
        fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Title/index.tsx",
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: "https://react.dev", target: "_blank", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "img",
        {
      ...
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("a", { href: "https://typescript.org", target: "_blank", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        "img",
        {
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("h1", { children: "Vite + React + TS" }, void 0, false, {
      fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Title/index.tsx",
      lineNumber: 27,
      columnNumber: 7
    }, globalThis),
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Typography$1, { variant: "caption", children: "Federación de módulos con vite" }, void 0, false, {
      fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/components/Title/index.tsx",
      lineNumber: 28,
      columnNumber: 7
    }, globalThis)
...
const ParcelTest = () => {
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    CardContainer,
    {
      ...
      mb: 5,
      children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { textAlign: "center", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Title, {}, void 0, false, {
            fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/pages/ParcelTest/index.tsx",
            lineNumber: 16,
            columnNumber: 9
          }, globalThis),
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Todos, {}, void 0, false, {
            fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/pages/ParcelTest/index.tsx",
            lineNumber: 18,
            columnNumber: 9
          }, globalThis)
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Box$1, { textAlign: "center", mx: "auto", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(CustomButton, {}, void 0, false, {
          fileName: "/home/martin/Development/Micro-Frontends/Prueba-de-concepto/Microfront-Concept-Remote-App-Test/src/pages/ParcelTest/index.tsx",
          lineNumber: 21,
          columnNumber: 9
        }, globalThis) }, void 0, false, {
...
export { ParcelTest as default, jsxDevRuntimeExports as j };
